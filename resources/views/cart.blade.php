            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                                ...
                                @foreach(Cart::content() as $product)
                                    <tr class="cart_item">
                                        ...
                                        <td class="product-remove">
                                            <a href="{{ route('cart.delete', $product->rowId) }}"
                                        ...
                                        <td class="product-thumbnail">
                                            ...
                                            <div class="cart-product__item">
                                                <a href="#">
                                                    <img src="{{ asset('storage/uploads/'.$product->model->image) }}"
                                                        alt="product"
                                        ...
                                        <td class="product-price">
                                            <h5 class="price amount">Rp {{ $product->price }}</h5>
                                        </td>

                                        <td class="product-quantity">

                                            <div class="quantity">
                                                <a href="{{ route('cart.decrement', ['rowId'=>$product->rowId, 'qty'=>$product->qty]) }}"
                                                    class="quantity-minus">-</a>
                                                <input title="Qty" class="email input-text qty text" type="text"
                                                    placeholder="1" value="{{ $product->qty }}" readonly>
                                                <a href="{{ route('cart.increment', ['rowId'=>$product->rowId, 'qty'=>$product->qty]) }}"
                    ...
                    <div class="cart-total">
                        ...
                        <h5 class="cart-total-total">Total: <span class="price">Rp {{ Cart::total() }}</span></h5>
